...
public class Student {
        ...
        /*
            ...
            2)After encapsulating a data, if you need you may read the value
              ...
              5)In setters;
              i)"Access Modifier " is "public"
              ii)"Return Type" must be the same with the "void" of the variable
              iii)"Method Name" should have "set + <Variable Name>" structure
              iv)Setters use "parameters",the parameter will be the same with variable

              6)If you want to create a hidden ,updatable but readable variable:
